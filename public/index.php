...
//ADMIN
    ...
    ->match('/admin/agent/new', 'admin/person/new', 'admin_agent_new')
    ...
    ->match('/admin/contact/new', 'admin/person/new', 'admin_contact_new')
    // Gestion des cibles
    ...
    ->match('/admin/target/new', 'admin/person/new', 'admin_target_new')
