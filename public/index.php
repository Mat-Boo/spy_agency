...
//ADMIN
    ...
    // Gestion des agents
    ->match('/admin/agent', 'admin/agent/index', 'admin_agent')
    /* ->match('/admin/agent/[i:id]', 'admin/agent/index', 'admin_agent') */
    ->match('/admin/agent/[i:id]/edit', 'admin/agent/edit', 'admin_agent_edit')
    ...
    ->match('/admin/contact', 'admin/contact/index', 'admin_contact')
    /* ->match('/admin/contact/[i:id]', 'admin/contact/index', 'admin_contact') */
    ->match('/admin/contact/[i:id]/edit', 'admin/contact/edit', 'admin_contact_edit')
    ...
    // Gestion des cibles
    ->match('/admin/target', 'admin/target/index', 'admin_target')
    /* ->match('/admin/target/[i:id]', 'admin/target/index', 'admin_target') */
    ->match('/admin/target/[i:id]/edit', 'admin/target/edit', 'admin_target_edit')
