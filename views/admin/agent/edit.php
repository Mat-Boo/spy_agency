...
$styleFolder = '../../../styles/';
$styleSubFolder = 'admin/agent/editAgent_';
...
/* var_dump($stashs->getStashs()); */


?>

<div class="agentEdit">
    <h1 class="missionEditTitle"><?= "Édition de l'agent' " .  $agent->getId_agent() ?></h1>
    <form 
        action=""
        method="POST"
        class="mission"
                ...
                <div class="InfosItems">
                    ...
                    <div class="infosItem stashs">
                        ...
                        <select name="stashMission[]" id="stashMission" multiple class="tashMission">
                            ...
                            <?php foreach($stashs->getStashs() as $stash) : ?>
                                <option
