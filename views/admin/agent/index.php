...
$agentsUniqueList = $agents->getAgentsUnique(); //Besoin pour Lister tous les agents uniques dans le filtre Agent
...
$specialitiesUniqueList = $specialities->getSpecialitiesUnique(); //Besoin pour Lister toutes les spécialités dans le filtre Spécialités
$specialities->hydrateAgents($agentsUniqueList, $specialitiesList);
        ...
        <div class="filters">
            <div class="filtersItemAndTitle">
                ...
                <div class="filtersItem">
                    <div class="agentsFiltersLine">
                        <div class="labelAndFilter">
                            <label for="agentfilter" class="filterTitle">Agent</label>
                            <select name="agentFilter[]" id="agentFilter" multiple class="filter">
                                ...
                                <?php foreach($agents->getAgentsUnique() as $agent) : ?>
                                    <option 
            ...
            <div class="filtersItemAndTitle">
                ...
                <div class="filtersItem">
                    <select name="missionFilter[]" id="missionFilter" multiple class="filter missionFilter">
...
<ul class="agentsList">
    <?php foreach($agentsUniqueList as $agent): ?>
        <li class="agent">
            <div class="headerAgent">
                <p class="AgentItem"><?= 'Agent ' . $agent->getId_Agent() ?></p>
            </div>
            <div class="infosAgent">
                <div class="AgentItems">
                    <p class="AgentItem"><b>Prénom: </b><?= $agent->getFirstname() ?></p>
                    <p class="AgentItem"><b>Nom: </b><?= $agent->getLastname() ?></p>
                    <p class="AgentItem"><b>Date de Naissance: </b><?= $agent->getBirthdate() ?></p>
                    <p class="AgentItem"><b>Nationalité: </b><?= $agent->getNationality() ?></p>
                </div>
                <?php if($isAdmin) : ?>
                    <div class="actionBtns">
                        <a href="<?= 'agent/' . $agent->getId_agent() .'/edit'?>" class="editBtn actionBtn">
                            <span>
                        ...
                        <a id="<?= $agent->getId_agent() . 'DeleteBtn' ?>" type="submit" class="deleteBtn actionBtn">
                            <span>
