...
$title = 'Spy Agency - Mission ' . $params['id'];
$styleFolder = '../../../assets/styles/';
$styleSubFolder = 'mission/viewMission_';
...
//Récupération de la liste des pays des agents, contacts, cibles et des planques
$agentCountries = [];
$contactCountries = [];
$targetCountries = [];
$stashCountries = [];
foreach(['agent', 'contact', 'target', 'stash'] as $item) {
    if ($item === 'stash') {
        foreach($missionArray[0]->getstashs() as $stash) {
            if (!in_array($stash->getCountry(), $stashCountries))
            $stashCountries[] = $stash->getCountry();
        }
    } else {
        foreach($missionArray[0]->{'get' . ucfirst($item) . 's'}() as ${$item}) {
            if (!in_array(${$item}->getNationality(), ${$item . 'Countries'}))
            ${$item . 'Countries'}[] = ${$item}->getNationality();
        }
    }
}
...
<div class="missionView">
    <a href="<?= $isAdmin ? $router->url('admin_mission') : $router->url('mission')?>" class="backBtn">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="backSvg actionSvg" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
        </svg>
        <span class="textBtn">Retour</span>
    </a>
    <h1 class="missionViewTitle">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
            <path d="M5 4a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1H5zm-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zM5 8a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1H5zm0 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1H5z"/>
            <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1z"/>
        </svg> 
        <?= 'Mission ' . $mission->getId_mission() ?>
    </h1>
    <div class="mission">
        ...
        <div class="infosMission">
            <div class="codenameCountryType">
                ...
                <div class="missionItem">
                    ...
                    <span class="spanInput"><?= $mission->getCountry() ?></span>
                </div>
                <div class="missionItem">
            ...
            <div class="dates">
                <div class="missionItem">
                    <span class="spanLabel"><b>Date de début: </b></span>
                    <span class="spanInput"><?= $mission->getConvertedStart_date() ?></span>
                </div>
                <div class="missionItem">
                    <span class="spanLabel"><b>Date de fin: </b></span>
                    <span class="spanInput"><?= $mission->getConvertedEnd_date() ?></span>
                </div>
            </div>
        </div>
        <div class="details">
                ...
                <div class="InfosItems">
                    <?php foreach(['agent', 'contact', 'target'] as $person): ?>
                        <div class="infosItem <?= $person . 's' ?>">
                            ...
                            <ul class="personsListAndCountry">
                                <?php foreach(${$person . 'Countries'} as $country): ?>
                                                ...
                                                <?php if(${$person . 'Mission'}->getNationality() === $country): ?>
                                                    <li class="personItem">
                                                        ...
                                                        <div class="specialities">
                                                            <small>
                                                                <?php if ($person === 'agent'): ?>
                                                                    <?= '- ' . implode('<br/>- ', ${$person . 'Mission'}->getSpecialities()) ?>
                                                                <?php endif ?>
                                                            </small>
                                                        </div>
                                                    </li>
                    ...
                    <div class="infosItem stashs">
                        ...
                        <ul class="stashsListAndCountry">
                            <?php if (count($mission->getStashs()) === 0): ?>
                                <p class="noStashMess"><i>Cette mission ne comporte pas de planque.</i></p>
                            <?php else: ?>
                                <?php foreach($stashCountries as $country): ?>
                                    <li class="countryItem">
                                        <p class="country"><b><?= $country ?></b></p>
                                        <ul class="stashsList">
        ...
        <?php if($isAdmin) : ?>
            <div class="actionBtns">
                <div class="CancelAndEditBtns">
                    <a href="<?= $router->url('admin_mission_edit', ['id' => $mission->getId_mission()]) ?>" class="actionBtn editBtn">
